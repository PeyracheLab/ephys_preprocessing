...
% Previously this was hardcoded as rxml.child(2), which assumes that the data lands in the second position of the xml. This
% seems to have changed after the creation of intanprocessing2, which results in a crash when running Process_LFPfromDat.m
% child(end) resolves this issue.
